...
const securityHeaders = [
  // The login background is a same-origin Three.js document embedded by the app.
  // SAMEORIGIN protects against third-party framing without blocking that scene.
